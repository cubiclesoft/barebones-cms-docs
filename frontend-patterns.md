...
All of the frontend examples require a copy of the Barebones CMS SDK in a subdirectory called 'support'.  The examples follow the [suggested tagging approach](https://github.com/cubiclesoft/barebones-cms-docs/blob/master/docs/asset-tagging.md) and assume a mostly static content website with some dynamic elements (i.e. a standard business website).  Adjust the examples for your use-case.
